...
import "./Veg.css"; // ✅ reuse same CSS as veg items
...
function NonVegItems() {
  ...
  const currentItems = nonVegItems.slice(startIndex, endIndex);

  return (
    <div className="container-fluid mt-4 px-3">
      {/* Heading */}
      <h3 className="mb-4 text-center">Welcome to Non-Veg Page</h3>
